...
{
	pr_debug("\x25\x73\x28\x29\x3a\x20\x53\x74\x61\x72\x74\x69\x6e\x67\x20\x72\x6d\x6e\x65\x74\x20\x53\x48\x53\x20\x6d\x6f\x64\x75\x6c\x65\x20\x25\x73\x20"
		"\n",
...
void __exit DATARMNETf3298dab6f(void)
{
	...
	DATARMNETeabd69d1ab();
	pr_debug("\x25\x73\x28\x29\x3a\x20\x45\x78\x69\x74\x69\x6e\x67\x20\x72\x6d\x6e\x65\x74\x20\x53\x48\x53\x20\x6d\x6f\x64\x75\x6c\x65"
		"\n",
		__func__);
}
static int DATARMNETe9173bbe0e(struct notifier_block *DATARMNET272c159b3c,
			       unsigned long DATARMNET7f045a1e6e, void *data)
{
	...
	case NETDEV_UNREGISTER:
		...
		if (!DATARMNET2cb9ae589c &&
			...
			pr_debug("\x72\x6d\x6e\x65\x74\x5f\x73\x68\x73\x20\x64\x65\x69\x6e\x69\x74\x20\x25\x73\x20\x67\x6f\x69\x6e\x67\x20\x64\x6f\x77\x6e\x20",
				dev->name);
	...
	case NETDEV_REGISTER:
		...
		if (DATARMNET2cb9ae589c &&
		    !DATARMNETecc0627c70.DATARMNETfc89d842ae) {
			pr_debug("\x72\x6d\x6e\x65\x74\x5f\x73\x68\x73\x20\x69\x6e\x69\x74\x69\x61\x6c\x69\x7a\x69\x6e\x67\x20\x25\x73",
				dev->name);
